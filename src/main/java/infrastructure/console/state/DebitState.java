...
/**
 * Класс состояния, отвечающий за добавление денег клиентом
 */
public class DebitState implements ConsoleState{
     ...
     */
    public DebitState(Client client){
        this.client = client;
    }
    /**
     * Метод, отвечающий за добавление денег клиентом
     */
    @Override
    public void process() {
        ...
        if(transactionService.debit(transactionID, amount, client.getLogin())){
